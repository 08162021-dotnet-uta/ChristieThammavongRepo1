...
namespace _5_OperatorsChallenge
{
    public class Program
    {
        ...
        /// <summary>
        /// This method takes two ints and returns true if the first value is greater or equal to the second value, otherwise false.
        /// </summary>
        /// <param name="num1"></param>
        /// <param name="!"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// This method takes two ints and returns true if num1 is greater than num2 or if num1 is greater than zero. Otherwise, false.
        /// </summary>
        /// <param name="num1"></param>
        /// <returns></returns>
